...
//! Project version number for STScale.
FOUNDATION_EXPORT double STScaleVersionNumber;

//! Project version string for STScale.
FOUNDATION_EXPORT const unsigned char STScaleVersionString[];
//
//// In this header, you should import all the public headers of your framework using statements like #import <STScale/PublicHeader.h>
//
////
////  HTBodyfat.h
////
