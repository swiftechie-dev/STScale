...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="STScale",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class CBPeripheral;

SWIFT_CLASS("_TtC7STScale9BleDevice")
...
SWIFT_PROTOCOL("_TtP7STScale15STScaleCallback_")
@protocol STScaleCallback
- (void)onNewScaleWithDev:(BleDevice * _Nonnull)dev;
- (void)onStateChangedBefore:(NSInteger)before after:(NSInteger)after;
- (void)onDataReceiveWithData:(ScaleData * _Nonnull)data;
@end


SWIFT_CLASS("_TtC7STScale14STScaleLibrary")
@interface STScaleLibrary : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) STScaleLibrary * _Nonnull instance;)
+ (STScaleLibrary * _Nonnull)instance SWIFT_WARN_UNUSED_RESULT;
+ (STScaleLibrary * _Nonnull)getInstance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (NSInteger)setUserInfoWithHeight:(NSInteger)height age:(NSInteger)age gender:(NSInteger)gender SWIFT_WARN_UNUSED_RESULT;
- (void)setCallBackWithCallback:(id <STScaleCallback> _Nonnull)callback;
- (NSInteger)startScan SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)stopScan SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)connectWithName:(NSString * _Nonnull)name address:(NSString * _Nonnull)address uuid:(NSString * _Nonnull)uuid SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)disconnect SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)setUnitWithUnit:(uint8_t)unit SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)getState SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC7STScale9ScaleData")
...
SWIFT_CLASS("_TtC7STScale8UserInfo")
...
+ (UserInfo * _Nullable)fromMapWithMap:(NSDictionary<NSString *, id> * _Nonnull)map SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
